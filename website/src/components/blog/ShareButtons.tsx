...
export function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  const shareLinks = [
    ...
    },
    {
      ...
      href: null, // Instagram has no share URL — copies link instead
        ...
        {shareLinks.map((item) =>
          item.href ? (
            <a
              ...
              className="w-9 h-9 rounded-full border border-border flex items-center justify-center text-ink-muted hover:text-primary hover:border-primary transition-all duration-200"
            >
              {item.icon}
            </a>
          ) : (
            <button
              ...
              aria-label={item.label}
              className="w-9 h-9 rounded-full border border-border flex items-center justify-center text-ink-muted hover:text-primary hover:border-primary transition-all duration-200 cursor-pointer"
            >
              {item.icon}
            </button>
          )
